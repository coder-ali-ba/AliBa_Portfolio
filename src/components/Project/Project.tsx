          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a
                  href="https://github.com/coder-ali-ba/Video-Calling-App"
                  target="_blank"
                  rel="noreferrer"
                >
            ...
            <div className="body">
              ...
              <p>
                It uses Socket.io to handle instant, bidirectional communication
                between users — such as joining rooms, sending call requests,
                and exchanging signaling data. For video and audio streaming,
                technologies like WebRTC are typically used, while Socket.io
                manages the real-time events (connect, disconnect, mute, chat,
                etc.).
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a
                  href="https://github.com/coder-ali-ba/Auth-BoilerPlate"
                  target="_blank"
                  rel="noreferrer"
                >
            ...
            <div className="body">
              <h3>Authentication Boilerplate</h3>
              <p>
                {" "}
                An authentication boilerplate using React (frontend) and Express
                (backend) provides a secure user login and registration system.
                The frontend handles user forms, protected routes, and JWT token
                management, while the backend manages user data, password
                hashing, and token generation using JWT. Multer is used to
                handle file uploads (such as profile images), and Cloudinary
                stores uploaded images securely in the cloud. This setup ensures
                secure authentication, protected APIs, and scalable media
                handling for modern web applications.{" "}
              </p>
            </div>
            <footer>
              {" "}
              <ul className="tech-list">
                {" "}
                <li>Express.js</li> <li>JWT</li> <li>React</li>{" "}
              </ul>{" "}
            </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a
                  href="https://github.com/coder-ali-ba/AI-Chatbot-BackEnd"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img src={githubIcon} alt="Visit site" />{" "}
                ...
                <a
                  href="https://ai-chatbot-front-end-three.vercel.app/"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img src={externalLink} alt="Visit site" />
            ...
            <div className="body">
              <h3>GeniusBot: AI-Powered Assistance & Chatbot</h3>
              <p>
                It uses Google Gemini to generate human-like responses, answer
                questions, assist with tasks, and provide contextual
                conversations. The chatbot can be integrated into web or mobile
                applications using APIs, allowing real-time interaction.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a
                  href="https://github.com/coder-ali-ba/Nexus"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img src={githubIcon} alt="Visit site" />
                ...
                <a
                  href="https://nexus-omega-rust.vercel.app/login"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img src={externalLink} alt="Visit site" />
            ...
            <div className="body">
              <h3>Investor Entrepreneur Collab</h3>
              <p>
                I implemented WebRTC-based video calling for seamless virtual
                meetings, built a document upload and preview system with an
                integrated digital signing feature, and developed a calendar
                module that allows users to select dates and manage meeting
                requests (confirm, accept, or decline).
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a
                  href="https://github.com/coder-ali-ba/ecommerce-frontend-design."
                  target="_blank"
                  rel="noreferrer"
                >
                  <img src={githubIcon} alt="Visit site" />
                ...
                <a
                  href="https://ecommerce-frontend-design-xepn.vercel.app/"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img src={externalLink} alt="Visit site" />
            ...
            <div className="body">
              ...
              <p>
                The frontend includes features such as product listings,
                category filters, product detail pages, shopping cart UI,
                responsive navigation, and a clean checkout interface —
                delivering a smooth and visually appealing online shopping
                experience.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a
                  href="https://github.com/coder-ali-ba/Full-Stack-QuizApp"
                  target="\_blank"
                  rel="noreferrer"
                >
                  <img src={githubIcon} alt="Visit site" />
            ...
            <div className="body">
              <h3>Fullstack Quizz App</h3>
              <p>
                I built a Fullstack Quiz App using HTML, CSS, and JavaScript for
                the frontend, with Firebase for authentication and real-time
                updates, and Supabase for storing quiz questions and user
                scores. The app allows users to register, take quizzes, track
                their scores, and view a leaderboard, providing a complete
